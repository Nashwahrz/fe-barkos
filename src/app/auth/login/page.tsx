    ...
    <div style={{ display: 'flex', minHeight: 'calc(100vh - 65px)', background: 'var(--background)', overflow: 'hidden' }}>
      ...
      <div className="hide-mobile" style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '560px', width: '100%' }}>
          ...
          <div style={{ marginBottom: '2.5rem', animation: 'floatAnim 6s ease-in-out infinite' }}>
            <svg width="180" height="180" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" style={{ filter: 'drop-shadow(0 20px 30px rgba(0,0,0,0.2))' }}>
              <path fill="#ffffff" fillOpacity="0.15" d="M45.7,-76.4C58.9,-69.3,68.9,-55.5,77.7,-41.4C86.5,-27.3,94.2,-13.6,93.6,-0.4C93,14.3,84.2,28.7,73.1,39.2C62,49.7,48.7,56.3,34.8,63.9C20.9,71.5,6.5,80.1,-6.6,83.1C-19.7,86,-31.4,83.4,-44,77.3C-56.6,71.3,-70.1,61.8,-79.1,49.1C-88.1,36.3,-92.6,20.3,-90.4,4.1C-88.2,-12,-79.3,-28.3,-67.7,-40.5C-56.1,-52.7,-41.8,-60.8,-28.1,-65.7C-14.4,-70.5,-1.3,-72.1,12.5,-71C26.2,-69.9,40.5,-66.1,52.1,-58C63.7,-50,72.5,-37.6,78.8,-24.1C85.1,-10.7,88.9,3.9,86.1,17.4C83.3,30.9,74,43.3,62.8,53.4C51.6,63.5,38.6,71.2,25,75.4" transform="translate(100 100) scale(1.1)" />
              <path fill="#ffffff" fillOpacity="0.3" d="M39.9,-65.4C52.1,-58.5,62.6,-48,70.9,-35.5C79.2,-23.1,85.2,-8.6,83.9,5.2C82.5,19,73.8,32,63.1,42.5C52.5,53,40,61,26.4,66C12.8,71,-1.8,73,-16.1,70.8C-30.5,68.6,-44.6,62.3,-56.1,52.4C-67.6,42.4,-76.6,28.8,-79.9,14C-83.3,-0.7,-81,-16.5,-73.2,-29.6C-65.5,-42.6,-52.3,-53,-38.7,-59.5C-25.1,-66,-11,-68.5,1.9,-71.7C14.8,-75,27.7,-72.3,39.9,-65.4Z" transform="translate(100 100) scale(0.95)" />
              <circle cx="100" cy="100" r="24" fill="#ffffff" fillOpacity="0.95" />
              <rect x="86" y="86" width="28" height="28" rx="8" fill="#047857" transform="rotate(45 100 100)" />
            </svg>
          </div>
          ...
          <p style={{ fontSize: '1.05rem', opacity: 0.9, lineHeight: 1.6, marginBottom: '3rem', maxWidth: '95%' }}>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <h2 style={{ fontSize: '1.65rem', fontWeight: 800, marginBottom: '0.25rem', color: 'var(--foreground)', letterSpacing: '-0.02em' }}>Masuk ke Akun</h2>
            <p style={{ opacity: 0.6, fontSize: '0.85rem', color: 'var(--foreground)' }}>Silakan isi detail Anda untuk melanjutkan</p>
          </div>
